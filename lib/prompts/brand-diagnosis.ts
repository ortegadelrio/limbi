...
export function buildBrandDiagnosisSystemInstructions(args: {
  ...
  return [
    ...
    "A partir de 70/100, considera que existe una base suficiente para avanzar; las recomendaciones deben plantearse como refinamientos o fortalecimientos, no como bloqueos.",
    "A partir de 70/100, evita frases como «impide consolidar», «no está lista», «presenta varias deficiencias», «falta una base mínima» o «no hay suficiente información».",
